...
<?php if ( ! $paged ) : ?>
	...
	<?php if ( $featured1_cat !== '' && arras_get_option( 'enable_featured1' ) ) : ?>
		...
		<div id="index-featured1" class="featured-section">
			<?php if ( arras_get_option( 'featured1_title' ) != '' ) : ?>
				<div
					class="home-title featured-section-title"><?php echo esc_html( arras_get_option( 'featured1_title' ) ); ?></div>
			<?php endif;
	...
	<?php if ( $featured2_cat !== '' && arras_get_option( 'enable_featured2' ) ) : ?>
		...
		<div id="index-featured2" class="featured-section">
			<?php if ( arras_get_option( 'featured2_title' ) != '' ) : ?>
				<div
					class="home-title featured-section-title"><?php echo esc_html( arras_get_option( 'featured2_title' ) ) ?></div>
			<?php endif;
	...
	<?php if ( arras_get_option( 'enable_news' ) ) : ?>
		...
		<div id="index-news" class="featured-section">
			<?php if ( arras_get_option( 'news_title' ) != '' ) : ?>
				<div
					class="home-title featured-section-title"><?php echo esc_html( arras_get_option( 'news_title' ) ) ?></div>
			<?php endif ?>
			<?php
	...
	<div class="below-content">
		<div id="bottom-content-1" class="widget-area below-content-widget-area">
			<?php if ( isset( $sidebars['bottom-1'] ) ) : ?>
				<div class="clearfix xoxo">
		...
		<div id="bottom-content-2" class="widget-area below-content-widget-area">
			<?php if ( isset( $sidebars['bottom-2'] ) ) : ?>
				<div class="clearfix xoxo">
