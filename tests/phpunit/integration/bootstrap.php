 ...
 * @return string
 */
function arras_get_wp_tests_dir() {
...
$arras_tests_dir = arras_get_wp_tests_dir();

// Give access to tests_add_filter() function.
require_once $arras_tests_dir . '/includes/functions.php';
...
tests_add_filter( 'setup_theme', function() {
	...
	switch_theme( basename( ARRAS_THEME_DIR ) );
} );

// Start up the WP testing environment.
require_once $arras_tests_dir . '/includes/bootstrap.php';

// Load the Integration Test Case.
require_once ARRAS_TESTS_DIR . '/ArrasIntegrationTestCase.php';
