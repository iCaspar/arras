...
function arras_get_default_option( $name ) {
	global $arras_options;
	// Need to force a reload of defaults from the actual hard-coded defaults here
	// because the previous instances defaults are stored with the current settings in the database
